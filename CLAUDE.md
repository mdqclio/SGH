...
node tests/probe_pagos_vista_incentivo_pagados.mjs  # Pagos vista por carrera (24/09) — incentivo de jockey con importe sólo en la carrera dueña (nº más bajo donde largó) + nota en las otras; chips de pagado (transferencia/efectivo/regularizado, anulado no cuenta); suma R9 = pendiente de la base; sintéticos + R9 real; --mutantes 15/15; solo lectura; LIQUIDACIONES_HTML acepta URL
