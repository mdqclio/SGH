...
│   ├── reunion_liquidacion_cerrada.sql  ISSUE-091 — reuniones.liquidacion_cerrada_at + triggers (líneas/headers de reunión cerrada: sólo service_role o migración; cerrar/reabrir: sólo super_admin) + cierre de R6/R8 TAL COMO ESTÁN en la misma transacción; rollback_reunion_liquidacion_cerrada.sql; **NO APLICADA** (PR feat/reparto-100-subroles)
...
### Reparto al 100 % y reuniones cerradas (25/09) — PR `feat/reparto-100-subroles`, sin aplicar
