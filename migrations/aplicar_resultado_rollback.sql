-- ROLLBACK: versión anterior de aplicar_resultado (sin no_largo)
-- Si hay que revertir: correr este SQL + revertir la columna manualmente:
--   ALTER TABLE resultado_posiciones DROP COLUMN IF EXISTS no_largo;
--   ALTER TABLE resultado_posiciones ALTER COLUMN posicion SET NOT NULL;
