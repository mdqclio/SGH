...
const MUTANTES = [
  ...
  { id: 'M6', tipo: 'sql', desc: 'el vínculo lleva DNI → el trigger crea OTRO propietario', mata: ['A1'],
    from: `  INSERT INTO caballeriza_responsables (caballeriza_id, propietario_id, rol, activo, nombre, documento_tipo)\n  VALUES (p_caballeriza_id, v_prop, 'propietario', true, v_cab.nombre, 'DNI')`,
    to:   `  INSERT INTO caballeriza_responsables (caballeriza_id, propietario_id, rol, activo, nombre, documento_tipo, documento_nro)\n  VALUES (p_caballeriza_id, v_prop, 'propietario', true, v_cab.nombre, 'DNI', '99999999')` },
