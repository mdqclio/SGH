...
NOTA estado: campo VARCHAR libre (sin ENUM ni CHECK). Valores reales medidos el 2026-08-27 sobre 49 filas: 'abierta' 31, 'anulada' 7, 'confirmada' 7, 'programada' 3, NULL 1. 'abierta' es el más común: lo escribe carta-llamados.html en toda carrera que guarda, no significa "inscripción abierta". 'reabierta' (cupo no completado, se reabre) figura en la UI pero hoy tiene 0 filas. NULL = sin marca especial. Filtrar siempre NULL-safe con .or('estado.is.null,estado.neq.anulada'): .neq() solo se traduce a estado <> 'anulada', que para NULL da NULL y descarta la fila en silencio (gotcha #5, ISSUE-038). Los conteos son una foto de su fecha.
