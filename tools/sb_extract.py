...
LISTA = [
    ("ALIADO SCAT", "?"), ("AMIGUITO JESUS", "?"), ("BACHUNA", "hembra"),
    ("BELLO PRESAGIO", "?"), ("BENDITO PRESAGIO", "macho-o-castrado"),
    ("CHE CARABANERA", "?"), ("COLONIAL JOHAN", "?"), ("DEVIL'S KING", "?"),
    ("EL BORJA", "macho-o-castrado"), ("EL MEJOR DUQUE", "macho-o-castrado"),
    ("ESTOY BLUE", "?"), ("FLORENTINA IN YOU", "?"), ("FREE CRY", "?"),
    ("GLAM METAL", "?"), ("LADY BLICK", "?"), ("MARUKA PLUS", "hembra"),
    ("NO TIENE CONTRAS", "?"), ("QUINIELA TREND", "?"), ("RIDGE PRINCE", "?"),
    ("SALVADOR EVER", "hembra"), ("SEÑOR MONCHI", "?"), ("SOL GALANA", "hembra"),
    ("SOY ISLEÑO", "?"), ("TIMBERA IN YOU", "?"), ("WISLA KEN", "?"),
    ("ZETA FOOT", "?"),
]
...
with open("/tmp/studbook_26.json", "w", encoding="utf-8") as f:
